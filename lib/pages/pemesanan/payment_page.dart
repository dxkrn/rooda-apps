...
//   BankInfo({
//     Key? key,
//     required this.bankMoreController,
//     required this.title,
//     required this.name,
//     required this.rek,
//   }) : super(key: key);
//   String title, name, rek;
//   final BankMoreController bankMoreController;

//   @override
//   Widget build(BuildContext context) {
//     return Container(
//       child: bankMoreController.isExpanded.value
//           ? GestureDetector(
//               onTap: () {
//                 // spesifikasiMoreController.isExpanded.value =
//                 //     !spesifikasiMoreController.isExpanded.value;
//                 bankMoreController.isExpanded.value =
//                     !bankMoreController.isExpanded.value;
//               },
//               child: Container(
//                 height: 50.w,
